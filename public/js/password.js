$(function () {
    var $password = $(".validate[type='password']");
...
$('#inputValidationEx2').on("change", callvalidator);
$('#inputValidationEx3').on("change", callvalidator);

$(button).attr("disabled", true);
function callvalidator() {
if( $('#inputValidationEx3').val() == $('#inputValidationEx2').val())
